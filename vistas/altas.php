    ...
    ">
        ...
        <form method="GET" action="undefined" class="w-75 mx-auto mt-5 mb-5">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="apellidoPaterno" name="apellido_paterno">
            </div>
            <div class="mb-3">
                <label class="form-label text-dark">Apellido Materno</label>
                <input type="text" class="form-control" id="apellidoMaterno" name="apellido_materno">
            </div>
            <div class="mb-3">
